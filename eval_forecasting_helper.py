...
def parse_arguments():
    ...
    parser.add_argument(
        "--forecast", default="", type=str, help="path to forecast file"
    )
    parser.add_argument("--horizon", default="", type=int, help="forecast horizon")
    parser.add_argument("--obs_len", default=20, type=int, help="Observed Length")
    parser.add_argument(
        "--miss_threshold", default=2.0, type=float, help="Threshold for miss rate"
    )
    parser.add_argument(
        "--features", default="", type=str, help="path to test features pkl file"
    )
    parser.add_argument(
        "--max_n_guesses", default=0, type=int, help="Max number of guesses"
    )
    parser.add_argument(
        "--prune_n_guesses",
        default=0,
    ...
    parser.add_argument(
        "--n_cl", default=0, type=int, help="Number of centerlines to consider"
    )
    parser.add_argument(
        "--viz", action="store_true", help="If true, visualize predictions"
    )
    parser.add_argument(
        "--viz_seq_id",
        default="",
...
if __name__ == "__main__":
    ...
    if args.viz:
        ...
        viz_predictions_helper(
            forecasted_trajectories, gt_trajectories, features_df, id_for_viz
        )
